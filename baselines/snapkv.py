...
class SnapKVCache(BaseCompressCache):
    """
    SnapKV-style cache policy.

    Keep a fixed recent window, optional sink tokens, and top-k older tokens
    selected by attention accumulated from the observation window.
    """
